...
export const sampleEvents: Event[] = [
  ...
  createEvent(
    'event-12',
    'Student Services Pop-up',
    'Ask quick questions about enrolment, finance, or IT support with the Service Connect team.',
    'event_servicesPopup_title',
    'event_servicesPopup_desc',
    2,
    '11:00 AM - 1:00 PM',
    "18 Wally's Walk (Central Hub)",
    '18WW',
    'Academic',
  ),
  createEvent(
    'event-13',
    'Library Late-Night Study Sprint',
    'Quiet study zone with librarians on call for research help and free snacks after 8pm.',
    'event_librarySprint_title',
    'event_librarySprint_desc',
    3,
    '8:00 PM - 10:30 PM',
    'Waranara Library Level 2',
    'LIB',
    'Academic',
  ),
  createEvent(
    'event-14',
    'Biz School Coffee Chat',
    'Meet classmates and faculty for an informal coffee hour in the Business School atrium.',
    'event_bizCoffee_title',
    'event_bizCoffee_desc',
    4,
    '10:00 AM - 11:00 AM',
    '4 Eastern Road Atrium',
    '4ER',
    'Social',
  ),
];
