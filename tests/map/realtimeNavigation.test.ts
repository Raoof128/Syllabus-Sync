...
describe('GpsPositionSmoother', () => {
  ...
  it('should smooth GPS positions with Kalman filter', () => {
    ...
    const positions = [
      { lat: -33.7737, lng: 151.1126, accuracy: 10, heading: null, speed: null, timestamp: 1000 },
      { lat: -33.7738, lng: 151.1127, accuracy: 12, heading: null, speed: null, timestamp: 2000 },
      { lat: -33.7736, lng: 151.1125, accuracy: 8, heading: null, speed: null, timestamp: 3000 }, // Noisy jump
      { lat: -33.7739, lng: 151.1128, accuracy: 10, heading: null, speed: null, timestamp: 4000 },
    ];
  ...
  it('should calculate movement heading from position history', () => {
    ...
    const positions = [
      { lat: -33.774, lng: 151.1126, accuracy: 5, heading: null, speed: null, timestamp: 1000 },
      { lat: -33.7738, lng: 151.1126, accuracy: 5, heading: null, speed: null, timestamp: 2000 },
      { lat: -33.7736, lng: 151.1126, accuracy: 5, heading: null, speed: null, timestamp: 3000 },
    ];
  ...
  it('should calculate speed from position history', () => {
    ...
    const positions = [
      { lat: -33.7737, lng: 151.1126, accuracy: 5, heading: null, speed: null, timestamp: 1000 },
      { lat: -33.77368, lng: 151.1126, accuracy: 5, heading: null, speed: null, timestamp: 2000 }, // ~2.2m north
      { lat: -33.77366, lng: 151.1126, accuracy: 5, heading: null, speed: null, timestamp: 3000 }, // ~2.2m north
    ];
