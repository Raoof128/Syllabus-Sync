...
describe("QuickActions", () => {
  ...
  it("renders all navigation links", () => {
    ...
    expect(
      screen.getByTestId("quick-action-manage-profiles"),
    ).toBeInTheDocument();
  });
  ...
  it("has correct href for each link", () => {
    ...
    expect(screen.getByTestId("quick-action-home")).toHaveAttribute(
      "href",
      "/home",
    );
    expect(screen.getByTestId("quick-action-calendar")).toHaveAttribute(
      "href",
      "/calendar",
    );
    expect(screen.getByTestId("quick-action-feed")).toHaveAttribute(
      "href",
      "/feed",
    );
    expect(screen.getByTestId("quick-action-map")).toHaveAttribute(
      "href",
      "/map",
    );
