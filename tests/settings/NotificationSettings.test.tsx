...
describe("NotificationSettings", () => {
  ...
  it("renders notification type items", () => {
    ...
    expect(
      screen.getByTestId("notification-item-deadlines"),
    ).toBeInTheDocument();
  ...
  it("renders toggle buttons for each notification type", () => {
    ...
    expect(
      screen.getByTestId("toggle-deadlines-notifications"),
    ).toBeInTheDocument();
    expect(
      screen.getByTestId("toggle-classes-notifications"),
    ).toBeInTheDocument();
    expect(
      screen.getByTestId("toggle-events-notifications"),
    ).toBeInTheDocument();
  });
  ...
  it("shows enabled/disabled state correctly", () => {
    ...
    const deadlinesToggle = screen.getByTestId(
      "toggle-deadlines-notifications",
    );
  ...
  it("shows enable button when permission is default", () => {
    ...
    expect(
      screen.getByTestId("enable-notifications-button"),
    ).toBeInTheDocument();
  });
