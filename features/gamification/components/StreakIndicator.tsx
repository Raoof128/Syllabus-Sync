    ...
    return (
      <div className={cn("flex items-center", config.container, className)}>
        <div
          className={cn(
            config.icon,
            "w-5 h-5 bg-mq-background-secondary rounded animate-pulse",
          )}
        />
      </div>
    );
  ...
  if (days === 0) {
    return (
      ...
      >
        ...
        {showCount && (
          <span className={cn(config.text, "text-mq-content-tertiary")}>
            {t("startStreak")}
          </span>
        )}
      </div>
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-2xl font-bold text-mq-content">
              {days}{" "}
              {days === 1
                ? t("streakCardTitle_one")
                : t("streakCardTitle_other")}
            </div>
        ...
        <div className="text-right">
          <div className="text-sm text-mq-content-tertiary">
            {t("streakBest")}
          </div>
