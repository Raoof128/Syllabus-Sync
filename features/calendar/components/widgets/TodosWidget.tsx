...
export default function TodosWidget({
  ...
  const toggleTodoNotification = useTodosStore(
          ...
          <CardContent className="pt-0">
            {todos.length === 0 ? (
              ...
              <div className="space-y-2 pr-1">
                ...
                {[...pendingTodos, ...todos.filter((t) => t.completed)].map(
                  (todo) => {
                    const due = dayjs(todo.dueDate);
                    const isOverdue = !todo.completed && due.isBefore(dayjs());
                    const isHighlighted =
                      todoHighlightActive && highlightedTodoId === todo.id;
                    ...
                    return (
                      <div
                        ...
                        onKeyDown={(e) =>
                          handleKeyDown(e, () => onOpenTodoDetail(todo))
                        }
                        role="button"
                        tabIndex={0}
                      >
