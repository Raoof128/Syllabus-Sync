 ...
 */
export function pixelToCrsSimple(
  x: number,
  y: number,
 ...
 */
export function getBuildingCrsCoords(building: Building): {
  lat: number;
  lng: number;
} {
  return pixelToCrsSimple(
    building.position[0] + BUILDING_PIXEL_OFFSET_X,
    building.position[1],
  );
}
 ...
 */
export function getBuildingGps(building: Building): {
  lat: number;
  lng: number;
} {
...
export const buildings: Building[] = [
  ...
  },
  {
    ...
    description:
      "Campus security headquarters and emergency first aid services. Available 24/7.",
  ...
  },
  {
    ...
    description:
      "Macquarie Law School, Media & Communication, Michael Kirby Law Building.",
  ...
  // MQ HEALTH
  {
    ...
    description:
      "Teaching hospital with specialist clinics, medical imaging, and pharmacy.",
  ...
  },
  {
    ...
    description:
      "General practice and physiotherapy clinics, specialist consultations.",
    tags: ["health", "medical", "services"],
  ...
  },
  {
    ...
    description:
      "Graduate Research Academy, Research Services, Commercialisation & Innovation.",
  ...
  // NEXTSENSE & SPECIALIST SERVICES
  {
    ...
    description:
      "NextSense Centre of Excellence for hearing, vision, and sensory research.",
  ...
  },
  {
    ...
    description:
      "Macquarie Engineering Technical Services - workshop and technical support.",
  ...
  // Additional buildings from MQ Location Guide
  {
    ...
    description:
      "Macquarie University Special Education Centre - education programs for children.",
  ...
  },
  {
    ...
    description:
      "Academic building with teaching spaces and exam halls. Faculty of Sciences.",
  ...
  },
  {
    ...
    description:
      "Main campus library with study spaces, Library Cafe, and extensive collections.",
  ...
  },
  {
    ...
    position: [4204, 2607],
    description:
      "Macquarie Centre shopping mall with food court, retail stores, and cinema.",
...

  {
    ...
    position: [2201, 1833],
    description:
      "Service Connect - main student services hub with IT, HR, and Financial Services.",
...

  {
    ...
    position: [1822, 2706],
    description:
      "Australian Hearing Hub - hearing research and clinical services.",
  ...
  // --- BUILDINGS FROM MQ LOCATION GUIDE CSV (2026-01-10) ---
  {
    ...
    description:
      "The Gale History Museum - historical exhibits and collections.",
  ...
  // =========================================================================
  // NEW LOCATIONS — sourced from MQ official campus map (m.html) 2026-02-10
  // =========================================================================
  ...
  // FOOD & DRINK
  {
    ...
    descriptionKey: "building_LBNMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.774214, lng: 151.113325 },
  },
  {
    id: "BKCMQ",
    name: "BAP Korean",
    ...
    descriptionKey: "building_BKCMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.774058, lng: 151.113779 },
  },
  {
    id: "BJMQ",
    name: "Boost Juice",
    ...
    descriptionKey: "building_BJMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.773581, lng: 151.112794 },
  },
  {
    id: "CTMQ",
    name: "Chatime",
    ...
    descriptionKey: "building_CTMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.774311, lng: 151.113772 },
  },
  {
    id: "EIMQ",
    name: "Eat Istanbul",
    ...
    descriptionKey: "building_EIMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.77331, lng: 151.11382 },
  },
  {
    id: "IMMQ",
    ...
    descriptionKey: "building_IMMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.773587, lng: 151.11281 },
  },
  {
    id: "IGGMQ",
    name: "Indi Go-Go",
    ...
    descriptionKey: "building_IGGMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.773587, lng: 151.11281 },
  },
  {
    ...
    descriptionKey: "building_LGBMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.773562, lng: 151.113215 },
  },
  {
    id: "LAMQ",
    name: "Little Asia",
    ...
    descriptionKey: "building_LAMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.773606, lng: 151.113187 },
  },
  {
    id: "MSMQ",
    name: "Monster Sushi",
    ...
    descriptionKey: "building_MSMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.774203, lng: 151.113436 },
  },
  {
    id: "PRMQ",
    name: "PappaRich",
    ...
    descriptionKey: "building_PRMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.774198, lng: 151.113534 },
  },
  {
    id: "RMQ",
    name: "Roll'd",
    ...
    descriptionKey: "building_RMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.774198, lng: 151.112661 },
  },
  {
    id: "SOMQ",
    name: "Soul Origin",
    ...
    descriptionKey: "building_SOMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.773577, lng: 151.113474 },
  },
  {
    id: "SLCMQ",
    ...
    descriptionKey: "building_SLCMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.773495, lng: 151.113687 },
  },
  {
    id: "SWMQ",
    name: "Sushi World",
    ...
    descriptionKey: "building_SWMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.773406, lng: 151.113362 },
  },
  {
    id: "TBMQ",
    name: "Taste Baguette",
    ...
    descriptionKey: "building_TBMQ_desc",
    address: "Central Courtyard",
    category: "food",
    location: { lat: -33.773446, lng: 151.113841 },
  },
  {
    id: "BUMQ",
    name: "(BREW)us",
    ...
    descriptionKey: "building_BUMQ_desc",
    address: "University Avenue",
    category: "food",
    location: { lat: -33.771791, lng: 151.115756 },
  },
  {
    id: "ECMQ",
    name: "esc Cafe",
    ...
    descriptionKey: "building_ECMQ_desc",
    address: "4 Research Park Drive",
    category: "food",
    location: { lat: -33.774628, lng: 151.117692 },
  },
  {
    id: "CCMQ",
    name: "Crunch Cafe",
    ...
    descriptionKey: "building_CCMQ_desc",
    address: "Gymnasium Road",
    category: "food",
    location: { lat: -33.772214, lng: 151.110554 },
  },
  {
    id: "WWC",
    name: "MQH Cafe",
    ...
    descriptionKey: "building_WWC_desc",
    address: "2 Technology Place",
    category: "food",
    location: { lat: -33.773449, lng: 151.118332 },
  },
  {
    id: "PICCOLO",
    name: "Piccolo Me",
    ...
    descriptionKey: "building_PICCOLO_desc",
    address: "Wally's Walk",
    category: "food",
    location: { lat: -33.776723, lng: 151.112015 },
  },
  ...
  // PARKING
  {
    ...
    descriptionKey: "building_PSOUTH2_desc",
    category: "services",
    location: { lat: -33.776533, lng: 151.114171 },
  },
  {
    id: "PEAST3",
    ...
    descriptionKey: "building_PEAST3_desc",
    category: "services",
    location: { lat: -33.775446, lng: 151.116794 },
  },
  {
    id: "PEAST2",
    ...
    descriptionKey: "building_PEAST2_desc",
    category: "services",
    location: { lat: -33.774567, lng: 151.116969 },
  },
  {
    id: "PWEST5",
    ...
    descriptionKey: "building_PWEST5_desc",
    category: "services",
    location: { lat: -33.773501, lng: 151.109232 },
  },
  {
    id: "PWEST4",
    ...
    descriptionKey: "building_PWEST4_desc",
    category: "services",
    location: { lat: -33.777012, lng: 151.109179 },
  },
  {
    id: "PWEST3",
    ...
    descriptionKey: "building_PWEST3_desc",
    category: "services",
    location: { lat: -33.775667, lng: 151.110247 },
  },
  ...
  // HOSPITAL PARKING
  {
    ...
    descriptionKey: "building_HEALTHP1_desc",
    category: "health",
    location: { lat: -33.772509, lng: 151.117418 },
    wheelchair: true,
  },
  {
    id: "HEALTHP2",
    ...
    descriptionKey: "building_HEALTHP2_desc",
    category: "health",
    location: { lat: -33.774105, lng: 151.117429 },
  },
  ...
  // ACCOMMODATION
  {
    ...
    descriptionKey: "building_130HR_desc",
    address: "130 Herring Road",
    category: "residential",
    location: { lat: -33.773631, lng: 151.113952 },
  },
  {
    id: "136HR",
    ...
    descriptionKey: "building_136HR_desc",
    address: "136 Herring Road",
    category: "residential",
    location: { lat: -33.778378, lng: 151.114336 },
  },
  ...
  // BIKE INFRASTRUCTURE
  {
    ...
    descriptionKey: "building_BIKEHUB_desc",
    category: "services",
    location: { lat: -33.775046, lng: 151.112583 },
  },
  {
    id: "BIKEHUBE",
    ...
    descriptionKey: "building_BIKEHUBE_desc",
    category: "services",
    location: { lat: -33.773842, lng: 151.115409 },
  },
  ...
  // STUDY SPACES
  {
    ...
    descriptionKey: "building_MUSE_desc",
    address: "Central Courtyard",
    category: "academic",
  ...
  // SPORTS
  {
    ...
    descriptionKey: "building_BBALL_desc",
    category: "sports",
    location: { lat: -33.773111, lng: 151.111416 },
  },
];
...
export const getBuildingById = (id: string): Building | undefined => {
  ...
  return buildings.find(
    (building) => building.id.toUpperCase() === normalizedId,
  );
};
