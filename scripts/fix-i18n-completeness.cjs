...
const translations = {
  ...
  ar: {
    ...
    building_18WW_desc:
      'مبنى خدمات الطلاب الرئيسي يضم Service Connect وتكنولوجيا المعلومات والموارد البشرية والخدمات المالية ومكاتب الإدارة.',
    ...
    building_25BWW_desc:
      'إدارة كلية الآداب والتعليم والعلوم الاجتماعية والدراسات الأصلية والتاريخ ومتحف غيل للتاريخ.',
    building_17WW_name: "17 Wally's Walk (القانون والإعلام)",
    building_17WW_desc:
      'كلية القانون بجامعة ماكواري، الإعلام والاتصالات، مبنى مايكل كيربي للقانون.',
    building_4ER_name: '4 Eastern Road (كلية الأعمال)',
    building_4ER_desc:
      'كلية الأعمال بجامعة ماكواري - المحاسبة والمالية والإدارة والتسويق والدراسات الاكتوارية.',
    building_75TAL_name: '75 Talavera Road (العلوم الصحية)',
    building_75TAL_desc:
      'كلية الطب والعلوم الصحية وكلية الطب والمعهد الأسترالي للابتكار الصحي وتقويم العمود الفقري.',
    building_16UA_name: '16 University Avenue (علم النفس)',
    building_16UA_desc:
      'علم النفس واللغويات وعيادة النطق والسمع وعيادة القراءة ومركز الصحة العاطفية.',
    ...
    building_8SCO_desc:
      'الطلاب المستقبليون، كلية ماكواري، أكاديمية ماكواري، غرفة الصلاة، مركز اختبار IELTS/PTE، الوصول وتوسيع المشاركة.',
    ...
    biometricNotConfigured:
      'لم يتم العثور على جهاز بيومتري. يرجى إعداد Face ID أو Touch ID أو Windows Hello على جهازك.',
    biometricPrivacyNote:
      'بياناتك البيومترية لا تغادر جهازك أبداً. نخزن فقط معرف بيانات الاعتماد الآمن.',
    enableBiometric: 'تفعيل تسجيل الدخول البيومتري',
    enableBiometricDesc:
      'إعداد Face ID أو Touch ID أو Windows Hello لتسجيل دخول أسرع وأكثر أماناً.',
    disableBiometric: 'تعطيل تسجيل الدخول البيومتري',
    disableBiometricDesc:
      'هل أنت متأكد أنك تريد تعطيل تسجيل الدخول البيومتري؟ ستحتاج إلى استخدام كلمة المرور لتسجيل الدخول.',
...
function generateTemplateTranslations(locale, missingKeys) {
  ...
  const localeMap = {
    ...
    es: {
      ...
      biometricLoginDesc:
        'Usa Face ID, Touch ID o Windows Hello para un inicio de sesión rápido y seguro',
      ...
      biometricSetupFailedMsg:
        'No se pudo configurar la autenticación biométrica. Por favor, intenta de nuevo.',
      biometricDeviceReady: 'Tu dispositivo soporta autenticación biométrica',
      biometricNotConfigured:
        'No se encontró dispositivo biométrico. Por favor, configura Face ID, Touch ID o Windows Hello en tu dispositivo.',
      biometricPrivacyNote:
        'Tus datos biométricos nunca salen de tu dispositivo. Solo almacenamos un ID de credencial seguro.',
      enableBiometric: 'Habilitar inicio biométrico',
      enableBiometricDesc:
        'Configura Face ID, Touch ID o Windows Hello para un inicio de sesión más rápido y seguro.',
      disableBiometric: 'Deshabilitar inicio biométrico',
      disableBiometricDesc:
        '¿Estás seguro de que quieres deshabilitar el inicio biométrico? Necesitarás usar tu contraseña para iniciar sesión.',
      moreSecurityFeatures: 'Más funciones de seguridad',
      moreSecurityFeaturesDesc:
        'Autenticación de dos factores, llaves de seguridad y gestión de contraseñas próximamente.',
      ...
      gamification_level_1: "Novato",
      gamification_level_2: "Aprendiz Entusiasta",
      gamification_level_3: "Estrella en Ascenso",
      gamification_level_4: "Erudito Dedicado",
      gamification_level_5: "Logro Académico",
      gamification_level_6: "Buscador de Conocimiento",
      gamification_level_7: "Campeón de Estudio",
      gamification_level_8: "Lista del Decano",
      gamification_level_9: "Élite Académica",
      gamification_level_10: "Maestro Erudito",
      gamification_level_veteran: "Veterano Académico",
      gamification_level_expert: "Experto en Conocimiento",
      gamification_level_legend: "Leyenda Erudita",
      gamification_level_titan: "Titán Académico",
      gamification_level_grand: "Gran Erudito",
      gamificationProgress: "Progreso de gamificación: Nivel {{level}} - {{title}}, {{xp}} XP",
      profileAvatar: "Avatar de perfil",
      userAvatar: "Avatar de {{name}}",
      unread: "No leído",
      noStreak: "Sin racha",
      streakDay: "Racha de {{count}} día(s)",
      streakDayTooltip: "¡Racha de {{count}} día(s)! Completa tareas diariamente para mantenerla. Tu racha más larga: {{longest}} días.",
      streakCardTitle_one: "Día",
      streakCardTitle_other: "Días",
      streakActive: "Racha Actual",
      streakInactive: "Racha Inactiva",
      streakBest: "Mejor",
      streakMotivation: "¡Completa una tarea para continuar tu racha!",
      startStreak: "¡Comienza una racha!",
      levelBadgeAria: "Nivel {{level}}, {{currentXP}} XP, {{xpToNext}} XP para el siguiente nivel",
      levelTooltip: "Nivel {{level}} • {{xp}} XP ganados. ¡Completa tareas para ganar XP y subir de nivel!",
      demo: "Demo",
      demoMode: "Modo Demo",
      signInToTrack: "Inicia sesión para rastrear tu progreso real",
      xpProgress: "Progreso de XP",
      xpToNextLevel: "{{xp}} XP para el Nivel {{nextLevel}}",
      dashboardOverview: "Resumen del panel",
      mainContent: "Contenido principal",
      footer: "Pie de página",
      stopNavigation: "Detener navegación",
      startTurnByTurn: "Iniciar navegación paso a paso",
      loadingMap: "Cargando mapa...",
      loadingBuildings: "Cargando edificios...",
      loadingFilters: "Cargando filtros...",
      wheelchairAccessible: "Accesible para silla de ruedas",
      eventStatistics: "Estadísticas de eventos y anuncios",
      closeNotification: "Cerrar notificación",
      mqSignpostAlt: "Señalización del campus de la Universidad Macquarie en Wally's Walk",
      mqSignpostAltGeneric: "Señalización del campus de la Universidad Macquarie",
      searchBuildingsPlaceholder: "Buscar edificios...",
      exampleTime: "ej., 2:00 PM - 4:00 PM",
      clearConfirm: "BORRAR"
    },
...
for (const locale of locales) {
  ...
  console.log(
    `🔧 ${locale}: Processing ${missingKeys.length} missing + ${untranslatedKeys.length} untranslated keys...`,
  );
  ...
  console.log(
    `   Added: ${addedCount} keys, Total: ${Object.keys(sortedTranslations).length} keys`,
  );
...
for (const r of results) {
  console.log(
    `| ${r.locale.padEnd(6)} | ${r.added.toString().padEnd(5)} | ${r.updated.toString().padEnd(7)} | ${r.total.toString().padEnd(5)} |`,
  );
}
