...
function generateTemplateTranslations(locale, missingKeys) {
  ...
  const localeMap = {
    ...
    es: {
      ...
      streakDayTooltip:
        '¡Racha de {{count}} día(s)! Completa tareas diariamente para mantenerla. Tu racha más larga: {{longest}} días.',
      ...
      levelTooltip:
        'Nivel {{level}} • {{xp}} XP ganados. ¡Completa tareas para ganar XP y subir de nivel!',
      demo: 'Demo',
      demoMode: 'Modo Demo',
