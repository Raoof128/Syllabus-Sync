...
const BATCH_2 = {
  ...
  tr: {
    ...
    errorProfileLoad: 'Profil ayarlarınız yüklenemedi. Bu durum teknik ekibimize bildirildi.',
  ...
  he: {
    ...
    youAreOfflineDesc: 'Syllabus Sync דורש חיבור לאינטרנט. אנא בדוק את החיבור שלך ונסה שוב.',
    errorProfileLoad: 'לא הצלחנו לטעון את הגדרות הפרופיל שלך. הנושא דווח לצוות ההנדסה שלנו.',
  ...
  ta: {
    ...
    loadingContentPleaseWait: 'உள்ளடக்கம் ஏற்றப்படுகிறது, தயவுசெய்து காத்திருக்கவும்',
    youAreOfflineDesc:
  ...
  si: {
    ...
    loadingContentPleaseWait: 'අන්තර්ගතය පූරණය වෙමින් පවතී, කරුණාකර රැඳී සිටින්න',
    youAreOfflineDesc:
