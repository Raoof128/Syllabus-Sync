...
const COMMON_TRANSLATIONS = {
  ...
  cs: {
    ...
    map: 'Mapa',
    settings: 'Nastavení',
    manageProfiles: 'Spravovat profil',
    loading: 'Načítání...',
    save: 'Uložit',
    cancel: 'Zrušit',
    delete: 'Smazat',
  ...
  da: {
    ...
    manageProfiles: 'Administrer profil',
    loading: 'Indlæser...',
    save: 'Gem',
    cancel: 'Annuller',
    delete: 'Slet',
  ...
  de: {
    ...
    manageProfiles: 'Profil verwalten',
  ...
  es: {
    ...
    map: 'Mapa',
    settings: 'Ajustes',
    manageProfiles: 'Gestionar perfil',
    loading: 'Cargando...',
    save: 'Guardar',
    cancel: 'Cancelar',
    delete: 'Eliminar',
  ...
  fa: {
    ...
    map: 'Kartta',
    settings: 'Asetukset',
    manageProfiles: 'Hallitse profiilia',
    loading: 'Ladataan...',
    save: 'Tallenna',
    cancel: 'Peruuta',
    delete: 'Poista',
  ...
  fr: {
    ...
    map: 'Carte',
    settings: 'Paramètres',
    manageProfiles: 'Gérer le profil',
    loading: 'Chargement...',
    save: 'Enregistrer',
    cancel: 'Annuler',
    delete: 'Supprimer',
  ...
  hu: {
    ...
    manageProfiles: 'Profil kezelése',
    loading: 'Betöltés...',
    save: 'Mentés',
    cancel: 'Mégse',
    delete: 'Törlés',
  ...
  it: {
    ...
    manageProfiles: 'Gestisci profilo',
    loading: 'Caricamento...',
    save: 'Salva',
    cancel: 'Annulla',
    delete: 'Elimina',
  ...
  nl: {
    ...
    manageProfiles: 'Profiel beheren',
    loading: 'Laden...',
    save: 'Opslaan',
    cancel: 'Annuleren',
    delete: 'Verwijderen',
  ...
  pl: {
    ...
    map: 'Mapa',
    settings: 'Ustawienia',
    manageProfiles: 'Zarządzaj profilem',
    loading: 'Ładowanie...',
    save: 'Zapisz',
    cancel: 'Anuluj',
    delete: 'Usuń',
  ...
  ro: {
    ...
    map: 'Hartă',
    settings: 'Setări',
    manageProfiles: 'Gestionare profil',
    loading: 'Se încarcă...',
    save: 'Salvează',
    cancel: 'Anulează',
    delete: 'Șterge',
  ...
  si: {
    ...
    map: 'සිතියම',
    settings: 'සැකසුම්',
    manageProfiles: 'පැතිකඩ කළමනාකරණය',
    ...
    view: 'බලන්න',
    today: 'අද',
    backToToday: 'අද දිනට ආපසු යන්න',
    status: 'තත්ත්වය',
    date: 'දිනය',
    location: 'ස්ථානය',
    units: 'ඒකක',
    deadlines: 'අවසාන දිනයන්',
    events: 'සමරු',
  ...
  ta: {
    ...
    map: 'வரைபடம்',
    settings: 'அமைப்புகள்',
    manageProfiles: 'சுயவிவர மேலாண்மை',
    ...
    view: 'பார்',
    today: 'இன்று',
    backToToday: 'இன்றுக்குத் திரும்பு',
    status: 'நிலை',
    date: 'தேதி',
    location: 'இடம்',
    units: 'பாடங்கள்',
  ...
  ur: {
    ...
    map: 'نقشہ',
    settings: 'ترتیبات',
    manageProfiles: 'پروفائل کا انتظام',
