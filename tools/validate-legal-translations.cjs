...
const PRIVACY_KEYS = [
  ...
  'privacy_s10_p2_part2',
  'privacy_s10_p2_part3',
  'privacy_s10_p2_part4',
  // Section 11
  'privacy_s11_p1_part1',
  'privacy_s11_p1_part2',
  'privacy_s11_p2_part1',
  'privacy_s11_p2_link',
  // Section 12
  'privacy_s12_p1_part1',
  'privacy_s12_p1_link',
  // Section 13
  'privacy_s13_p1',
  // Section 14
...
const issueLocales = results.filter(
  (r) =>
    r.privacyMissing.length ||
    r.privacyUntranslated.length ||
    r.termsMissing.length ||
    r.termsUntranslated.length,
);
...
console.log(
  `Privacy issues: ${totalPrivacyIssues} across ${localesNeedingPrivacyFix.length} locale(s)`,
);
console.log(
  `Terms issues:   ${totalTermsIssues} across ${localesNeedingTermsFix.length} locale(s)`,
);
