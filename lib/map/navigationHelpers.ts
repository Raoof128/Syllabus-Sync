...
export function openGoogleMaps(origin: { lat: number; lng: number } | null, dest: { lat: number; lng: number }) {
...
export function openAppleMaps(origin: { lat: number; lng: number } | null, dest: { lat: number; lng: number }) {
...
export function openBestNavApp(origin: { lat: number; lng: number } | null, dest: { lat: number; lng: number }) {
