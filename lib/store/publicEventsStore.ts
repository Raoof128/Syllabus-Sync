...
const createSampleEvents = (): PublicEvent[] => {
  ...
  return [
    ...
    { id: 'aaaaaaaa-0001-4000-8000-000000000002', title: 'AI & Ethics Public Lecture', description: 'Guest speaker Prof. Sarah Chen discusses ethical implications of generative AI in education.', startAt: new Date('2026-03-10T14:00:00+11:00'), endAt: new Date('2026-03-10T16:00:00+11:00'), allDay: false, location: '4 Eastern Road Auditorium', building: '4ER', category: 'Academic', isFeatured: true, priority: 70, createdAt: now },
