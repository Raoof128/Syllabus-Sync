...
const createSampleEvents = (): PublicEvent[] => {
  ...
  return [
    ...
    { id: 'aaaaaaaa-0004-4000-8000-000000000003', title: 'Outdoor Movie Night', description: 'Screening of Interstellar on the big screen. BYO blankets and snacks!', startAt: new Date('2026-03-15T19:00:00+11:00'), endAt: new Date('2026-03-15T22:00:00+11:00'), allDay: false, location: 'Sports Fields', building: 'FIELDS', category: 'Social', isFeatured: false, priority: 70, createdAt: now },
