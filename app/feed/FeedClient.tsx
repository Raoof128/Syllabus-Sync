          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="bg-mq-surface border border-mq-border rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
              <div className="flex items-center gap-3 mb-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-mq-error/10 ring-2 ring-mq-error/20">
                  <Trash2 className="h-6 w-6 text-mq-error" />
                </div>
                <div>
              ...
              <div className="flex justify-end gap-3">
                ...
                <Button
                  ...
                  className="bg-mq-error hover:bg-mq-error/90 text-white"
                >
                  {t('confirmDelete')}
                </Button>
              </div>
