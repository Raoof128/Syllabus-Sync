        ...
        <div className="lg:grid lg:grid-cols-[220px_1fr] lg:gap-12">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <h3 className="text-sm font-semibold text-mq-content">
                {t("privacy_s2_b_title")}
              </h3>
              <ul className="space-y-1.5">
                {(["privacy_s2_b_li1", "privacy_s2_b_li2"] as const).map(
                  (k) => (
                    <li
                      key={k}
                      className="flex items-start gap-2 text-sm text-mq-content-secondary"
              ...
              <h3 className="text-sm font-semibold text-mq-content">
                {t("privacy_s2_d_title")}
              </h3>
              <ul className="space-y-1.5">
                {(["privacy_s2_d_li1", "privacy_s2_d_li2"] as const).map(
                  (k) => (
                    <li
                      key={k}
                      className="flex items-start gap-2 text-sm text-mq-content-secondary"
                    ...
                    {[
                      ...
                      >
                        {row.map((cell) => (
                          <td
                            key={cell}
                            className="px-4 py-3 text-mq-content-secondary"
                          >
