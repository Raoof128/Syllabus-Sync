...
const UnitDetailPanel = dynamic(
  () => import("@/components/units/UnitDetailPanel"),
  {
    loading: () => null,
  },
);
...
const ExamDetailPanel = dynamic(
  () => import("@/components/exams/ExamDetailPanel"),
  {
    loading: () => null,
  },
);
...
const EventDetailPanel = dynamic(
  () => import("@/components/events/EventDetailPanel"),
  {
    loading: () => null,
  },
);

const TodoDetailPanel = dynamic(
  () => import("@/features/calendar/components/TodoDetailPanel"),
  {
    loading: () => null,
  },
);
          ...
          <h1 className="min-w-0 flex-1 truncate text-lg font-bold text-mq-content sm:text-xl">
            {formatMonthYear(
              dayjs(currentWeekStart)
                .add(mobileSelectedDayIndex, "day")
                .toDate(),
            )}
          </h1>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isToday &&
                    !isSelected &&
                    "border border-mq-primary text-mq-primary",
                )}
              >
      ...
      <div className="relative flex min-h-0 flex-1 flex-col lg:flex-row lg:overflow-hidden">
        ...
        <CalendarSidebar className="order-2 lg:order-none">
          <CalendarWidgets
            ...
            assignmentsWidgetRef={
              assignmentsWidgetRef as React.RefObject<HTMLDivElement>
            }
          />
        </CalendarSidebar>
      </div>
              ...
              <div>
                ...
                <select
                  ...
                  className={cn(
                    ...
                    editTodoPriority === "High" &&
                      "text-red-600 dark:text-red-400",
                    editTodoPriority === "Medium" &&
                      "text-amber-600 dark:text-amber-400",
                    editTodoPriority === "Low" &&
