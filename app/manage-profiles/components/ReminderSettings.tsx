              ...
              <div className="space-y-3 p-3 bg-mq-card-background rounded-mq border border-mq-border">
                ...
                {deadlinesEnabled && (
                  <Select
                    ...
                    onValueChange={(value) =>
                      setDeadlineReminderTiming(parseInt(value))
                    }
                  >
              ...
              <div className="space-y-3 p-3 bg-mq-card-background rounded-mq border border-mq-border">
                ...
                {classesEnabled && (
                  <Select
                    ...
                    onValueChange={(value) =>
                      setClassReminderTiming(parseInt(value))
                    }
                  >
                    <SelectTrigger className="mt-2">
                      <SelectValue />
                    ...
                    <SelectContent>
                      {REMINDER_TIMINGS.filter((t) => t.value <= 120).map(
                        (timing) => (
                          <SelectItem
                            key={timing.value}
                            value={timing.value.toString()}
              ...
              <div className="space-y-3 p-3 bg-mq-card-background rounded-mq border border-mq-border">
                ...
                {eventsEnabled && (
                  <Select
                    ...
                    onValueChange={(value) =>
                      setEventReminderTiming(parseInt(value))
                    }
                  >
                    <SelectTrigger className="mt-2">
                      <SelectValue />
