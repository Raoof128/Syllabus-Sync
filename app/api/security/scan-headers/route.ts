...
} from "@/lib/security/headers-scanner";
...
const BLOCKED_PORTS = new Set([
  22, 25, 3306, 5432, 6379, 9200, 9300, 11211, 27017, 2375, 2376,
]);
...
async function validateScanTarget(
  rawUrl: string,
): Promise<{ valid: true; url: URL } | { valid: false; message: string }> {
  let parsed: URL;
