/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: f821f9761501c23a9ddc543f319c761a)
// Runtime types generated with workerd@1.20260721.1 2026-07-22 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
  ...
  WORKER_SELF_REFERENCE:
    | Fetcher /* syllabus-sync-production */
    | Service<typeof import('./custom-worker').default>;
}
declare namespace Cloudflare {
  ...
  interface ProductionEnv {
    ...
    WORKER_SELF_REFERENCE: Fetcher /* syllabus-sync-production */;
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'DEPLOYMENT_PLATFORM' | 'DEPLOYMENT_ENV'>
  > {}
}
