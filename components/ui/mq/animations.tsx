...
export const fadeIn = cn(
  'animate-in fade-in duration-mq-slow ease-mq-ease'
);

/**
 * Utility function to combine hover lift with other classes
 */
export const withHoverLift = (className?: string) =>
  cn(hoverLift, className);

/**
 * Utility function to combine fade-in with other classes
 */
export const withFadeIn = (className?: string) =>
  cn(fadeIn, className);