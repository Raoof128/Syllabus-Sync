    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="h-9 w-9 text-mq-content-secondary hover:text-mq-content hover:bg-mq-background-secondary rounded-mq-md transition-colors" title="Keyboard Shortcuts">
                    <Keyboard className="h-5 w-5" />
                </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="w-72 bg-mq-background border-mq-border shadow-mq-lg rounded-mq-lg p-2">
                ...
                <div className="space-y-1 mt-1">
                    {shortcuts.map((shortcut, index) => (
                        <div key={index} className="flex items-center justify-between px-2 py-1.5 rounded-mq-md hover:bg-mq-background-secondary/50 text-mq-sm">
