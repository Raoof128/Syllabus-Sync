...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn(
        'flex cursor-default items-center justify-center py-1 text-mq-content-secondary hover:text-mq-content',
        className,
      )}
      {...props}
    >
