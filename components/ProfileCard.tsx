            ...
            <div className="flex gap-1 self-end sm:self-auto">
              {!isCurrent && (
                <Button
                  ...
                  className="h-8 w-8 p-0 text-mq-content-secondary dark:text-white/80 hover:text-mq-primary"
              ...
              <Button
                ...
                className="h-8 w-8 p-0 text-mq-content-secondary dark:text-white/80 hover:text-mq-success"
