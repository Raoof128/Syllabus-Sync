...
export const EventDetailModal = memo(({
  ...
  const buildingInfo = event.building
    ? buildings.find((b) => b.id === event.building)
    : null;
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-lg p-0 overflow-hidden">
        ...
        <div
          className={cn(
            'relative bg-linear-to-br p-6 pb-8',
            style.gradient
          )}
        >
          {/* Decorative Elements */}
        ...
        <div className="p-6 space-y-5">
          ...
          <div>
            ...
            <p className="text-mq-content leading-relaxed">
              {event.description}
            </p>
          </div>
          ...
          <div className="flex items-start gap-3 p-4 rounded-xl bg-mq-background-secondary">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm font-semibold text-mq-content mb-1">
                {event.location}
              </p>
              {buildingInfo && (
          ...
          <div className="pt-2 border-t border-mq-border">
            ...
            {isAdded && (
              <p className="text-xs text-mq-content-tertiary text-center mt-2">
                {t('eventAddedInfo') || 'This event has been added to your personal calendar. You can view it in the Calendar tab.'}
              </p>
            )}
          </div>
        </div>
