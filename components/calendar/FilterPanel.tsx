...
import { Filter, X, Check, BookOpen, AlertCircle, Calendar as CalendarIcon } from 'lucide-react';
                ...
                >
                    <div className="p-4 grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 items-center">
                        ...
                        <div className="flex flex-col gap-2">
                            <span className="text-xs font-bold text-mq-content-secondary uppercase tracking-wider">View Options</span>
                            <div className="flex items-center gap-2">
                                <Switch
                                    ...
                                    id="filter-units"
                                />
                                <label htmlFor="filter-units" className="text-sm font-medium flex items-center gap-2 cursor-pointer select-none">
                            ...
                            <div className="flex items-center gap-2">
                                <Switch
                                    ...
                                    id="filter-deadlines"
                                />
                                <label htmlFor="filter-deadlines" className="text-sm font-medium flex items-center gap-2 cursor-pointer select-none">
                        ...
                        <div className="flex flex-col gap-2">
                            <span className="text-xs font-bold text-mq-content-secondary uppercase tracking-wider opacity-0 md:opacity-100">Additional</span>
                            <div className="flex items-center gap-2">
                                <Switch
                                    ...
                                    id="filter-events"
                                />
                                <label htmlFor="filter-events" className="text-sm font-medium flex items-center gap-2 cursor-pointer select-none">
                            ...
                            <div className="flex items-center gap-2">
                                <Switch
                                    ...
                                    id="filter-completed"
                                />
                                <label htmlFor="filter-completed" className="text-sm font-medium flex items-center gap-2 cursor-pointer select-none">
