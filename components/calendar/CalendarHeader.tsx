                    ...
                    <div className="flex items-center p-1 bg-mq-surface border border-mq-border rounded-lg mr-2">
                        <button
                            ...
                            className={cn(
                                ...
                                view === 'week' ? 'bg-mq-background shadow-sm text-mq-content' : 'text-mq-content-secondary hover:text-mq-content'
                            )}
                        >
                            Week
                        </button>
                        <button
                            ...
                            className={cn(
                                'px-3 py-1.5 text-sm font-medium rounded-md transition-colors',
                                view === 'day' ? 'bg-mq-background shadow-sm text-mq-content' : 'text-mq-content-secondary hover:text-mq-content'
                            )}
                        >
                            Day
                        </button>
                        <button
                            ...
                            className={cn(
                                'px-3 py-1.5 text-sm font-medium rounded-md transition-colors',
                                view === 'agenda' ? 'bg-mq-background shadow-sm text-mq-content' : 'text-mq-content-secondary hover:text-mq-content'
                            )}
                        >
                            Agenda
                        </button>
