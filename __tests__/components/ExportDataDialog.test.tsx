...
import { ExportDataDialog } from '@/app/settings/components/privacy/ExportDataDialog';
...
describe('ExportDataDialog', () => {
  ...
  it('renders correctly when open', () => {
    render(
      <ExportDataDialog open={true} onOpenChange={mockOnOpenChange} t={mockT} language="en" />,
    );
