...
Raouf: 2026-02-10 (Australia/Sydney)
Scope: Empty legacy directory cleanup
Summary: Removed leftover empty `__tests__` and `types` directories after migration.

Raouf: 2026-02-10 (Australia/Sydney)
Scope: Feature tree cleanup
Summary: Removed empty scaffold-only feature subdirectories; typecheck remains green.
